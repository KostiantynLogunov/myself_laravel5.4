...
<div class="back-shapes">
    ...
    <div class="container">
        {!! link_to(route('user'), 'Back' )!!}

        <div class="wrapper pt-2" style="color: #fff;">
            {!! Form::open(['url' => route('UserSettings'),'class'=>'form-horizontal','method'=>'POST','enctype'=>'multipart/form-data']) !!}
            <div class="form-group">
                {!! Form::hidden('id', Auth::user()->id) !!}
                {!! Form::label('name', 'Name:',['class'=>'col-xs-2 control-label']) !!}
                <div class="col-xs-8">
                    {!! Form::text('name', Auth::user()->name, ['class' => 'form-control','placeholder'=>'Enter name of user']) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('email', Auth::user()->email, ['class' => 'form-control','placeholder'=>'Enter email of user']) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-offset-2 col-xs-10">
                    {!! Html::image('assets/img/users/'.Auth::user()->images,'',['class'=>' img-responsive','width'=>'150px']) !!}
                    {!! Form::hidden('old_images', Auth::user()->images) !!}
                </div>
            </div>
