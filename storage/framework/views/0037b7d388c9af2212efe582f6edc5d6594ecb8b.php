...
<div class="back-shapes">
    ...
    <div class="container">
        <?php echo link_to(route('user'), 'Back' ); ?>


        <div class="wrapper pt-2" style="color: #fff;">
            <?php echo Form::open(['url' => route('UserSettings'),'class'=>'form-horizontal','method'=>'POST','enctype'=>'multipart/form-data']); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    <?php echo Form::text('name', Auth::user()->name, ['class' => 'form-control','placeholder'=>'Enter name of user']); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    <?php echo Form::text('email', Auth::user()->email, ['class' => 'form-control','placeholder'=>'Enter email of user']); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-offset-2 col-xs-10">
                    <?php echo Html::image('assets/img/users/'.Auth::user()->images,'',['class'=>' img-responsive','width'=>'150px']); ?>

                    <?php echo Form::hidden('old_images', Auth::user()->images); ?>
